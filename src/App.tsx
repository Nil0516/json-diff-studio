        ...
        <section className="editor-grid">
          <article className="editor-card">
            <div className="editor-header">
              ...
              <button type="button" className="ghost editor-action-btn" onClick={() => handleFormat("leftInput")}>
                {t(locale, "formatJson")}
              </button>
            </div>
            <textarea
          ...
          <article className="editor-card">
            <div className="editor-header">
              ...
              <button type="button" className="ghost editor-action-btn" onClick={() => handleFormat("rightInput")}>
                {t(locale, "formatJson")}
              </button>
            </div>
            <textarea
